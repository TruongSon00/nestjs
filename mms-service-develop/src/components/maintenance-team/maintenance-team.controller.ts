...
export class MaintenanceTeamController {
  ...
  // @MessagePattern('list_maintenance_team')
  ...
  async getList(
    ...
    return await this.maintenanceTeamService.getList(request);
  }

  // @MessagePattern('list_maintenance_team_and_user')
  ...
  // @MessagePattern('detail_maintenance_team')
  ...
  // @MessagePattern('update_maintenance_team')
