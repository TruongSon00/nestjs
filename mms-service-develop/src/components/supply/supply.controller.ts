...
import { CONFIRM_SUPPLY_PERMISSION, CREATE_SUPPLY_PERMISSION, DELETE_SUPPLY_PERMISSION, DETAIL_SUPPLY_PERMISSION, EXPORT_SUPPLY_PERMISSION, LIST_SUPPLY_PERMISSION, UPDATE_SUPPLY_PERMISSION } from '@utils/permissions/supply';
