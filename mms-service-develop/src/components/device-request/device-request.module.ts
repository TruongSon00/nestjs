...
import { DeviceReturnTicketRepository } from '../../repository/device-return-ticket/device-return-ticket.repository';
import { DeviceRequestTicketSchema } from '../../models/device-request-ticket/device-request-ticket.schema';
import { DeviceReturnTicketSchema } from '../../models/device-return-ticket/device-return-ticket.schema';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: 'DeviceReturnTicket', schema: DeviceReturnTicketSchema },
    ]),
    UserModule,
    HistoryModule,
    ProduceModule,
  ...
  providers: [
    ...
    {
      provide: 'DeviceReturnTicketRepositoryInterface',
      useClass: DeviceReturnTicketRepository,
    },
    {
